...
- In the local function app:
  ...
  - Run `npm link @azure/functions-opentelemetry-instrumentation`. This will point your app to the local repository for the `@azure/functions-opentelemetry-instrumentation` package
